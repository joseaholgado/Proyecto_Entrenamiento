...
public class PantallaLogin extends JPanel {
	...
	public PantallaLogin(Ventana v) {
		...
		reproductor.reproducir("./bola_de_dragon_z_prologo_del_capitulo.wav");

		// -----------------------------------------------------

		GridBagLayout gridBagLayout = new GridBagLayout();
		gridBagLayout.columnWidths = new int[] { 216, 204, 187, 0, 0 };
		gridBagLayout.rowHeights = new int[] { 40, 28, 30, 52, 52, 37, 37, 42, 38, 0, 0 };
		...
		gbc_checkMusica.insets = new Insets(0, 0, 0, 5);
		gbc_checkMusica.gridx = 0;
		gbc_checkMusica.gridy = 9;
