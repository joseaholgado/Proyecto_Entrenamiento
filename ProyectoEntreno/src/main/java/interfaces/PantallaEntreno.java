	...
	public PantallaEntreno(Ventana v) {
		...
		if ((int) consulta.get(2) == 1) {
			...
			Material material3 = new Material("Agarre cuerda",
					"Cuerda en forma de v con enganche en maquina con poleas", null);
			...
			Ejercicio ej12 = new Series("Elevación de gemelos con mancuerna",
					"Apoyado las puntas en un escalón o step. Dejarse caer el taló y levantarse completamente con mancuerna",
